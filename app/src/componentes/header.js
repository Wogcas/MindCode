          ...
          <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
              ...
              <div class="flex-shrink-0 flex items-center cursor-pointer">
                <img src="/app/assets/images/logoMindCode.png" class="h-10"/>
              ...
              <div class="flex-1 flex items-center justify-end md:justify-between mx-2 md:mx-8">
                <div class="flex-1 max-w-md mr-2 md:mr-0">
                  <div class="relative text-gray-500 focus-within:text-gray-600">
                    <input type="text" name="search" id="search" placeholder="Explorar Cursos"
                      class="block w-full h-10 pl-4 pr-10 py-2 leading-5 font-medium text-gray-700
                             placeholder-gray-500 bg-blue-100/50 border-transparent rounded-full
                             focus:outline-none focus:bg-blue-100 focus:ring-0 sm:text-sm transition-colors duration-200">
                ...
                <nav class="hidden md:flex space-x-4 lg:space-x-8 ml-4">
                  <a href="/app/src/shell/index.html" class="text-gray-900 font-semibold px-3 py-2 text-sm hover:text-primary-600 transition-colors">Inicio</a>
                  <a href="#" class="text-gray-600 font-medium px-3 py-2 text-sm hover:text-primary-600 transition-colors">Cursos</a>
                  <a href="/app/src/shell/retos.html" class="text-gray-600 font-medium px-3 py-2 text-sm hover:text-primary-600 transition-colors">Retos</a>
              ...
              <div class="flex items-center gap-4">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                  stroke-width="1.5" stroke="currentColor" class="h-6 w-6 text-gray-700">
                  <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <button type="button" class="flex p-1 rounded-full text-gray-600 hover:text-primary-600 hover:bg-gray-100 focus:outline-none transition-colors">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke-width="1.5" stroke="currentColor" class="w-7 h-7 sm:w-8 sm:h-8">
                    <path stroke-linecap="round" stroke-linejoin="round"
                      d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                  </svg>
                </button>
