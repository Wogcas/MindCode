                    ...
                    <div class="flex-1 overflow-y-auto px-6 py-6 custom-scrollbar">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <button class="visibilidad-option w-full flex items-center gap-3 bg-gray-50 border border-gray-200 rounded-xl p-3 mb-3 transition-all hover:bg-blue-50 active" data-visibilidad="publico">
                                ...
                                <button class="visibilidad-option w-full flex items-center gap-3 bg-gray-50 border border-gray-200 rounded-xl p-3 transition-all hover:bg-blue-50" data-visibilidad="privado">
